...
api.add_route('/v1/vendor-item', vendor_item_handlers.VendorItemCollectionResource())
api.add_route('/v1/vendor-item/{vendor_name}/{vendor_item_id}', inventory_handlers.VendorItemDetailResource())
